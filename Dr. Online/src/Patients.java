...
public class Patients extends JFrame {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Patients frame = new Patients(name);
	...
	public Patients(String name) {
		...
		JMenuItem update_rep = new JMenuItem("Update Reply");
		mnNewMenu_1.add(update_rep);
		
		JMenuItem delete_rep = new JMenuItem("Delete Reply");
		mnNewMenu_1.add(delete_rep);
		...
		JMenuItem add_meds = new JMenuItem("Add Medication");
		add_meds.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
		...
		mnNewMenu_2.add(add_meds);
		
		JMenu mnNewMenu_4 = new JMenu("Update Medication");
		mnNewMenu_2.add(mnNewMenu_4);
		
		JMenuItem mntmNewMenuItem = new JMenuItem("Medication info");
		mntmNewMenuItem.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				update_med x = new update_med();
				x.setVisible(true);
				x.setDefaultCloseOperation(JFrame.HIDE_ON_CLOSE);
			}
		});
		...
		JMenuItem mntmNewMenuItem_1 = new JMenuItem("Medication for patient");
		mntmNewMenuItem_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				update_medpat x = new update_medpat();
				x.setVisible(true);
				x.setDefaultCloseOperation(JFrame.HIDE_ON_CLOSE);
			}
		});
		...
		JMenuItem delete_meds = new JMenuItem("Delete Medication");
		delete_meds.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				delete_med x = new delete_med();
				x.setVisible(true);
				x.setDefaultCloseOperation(JFrame.HIDE_ON_CLOSE);
			}
		});
		mnNewMenu_2.add(delete_meds);
		
		JMenu mnNewMenu_3 = new JMenu("Doctor Rating");
		mnNewMenu_3.setFont(new Font("Segoe UI", Font.PLAIN, 15));
		menuBar.add(mnNewMenu_3);
		
		JMenuItem add_rat = new JMenuItem("Add Rating");
		add_rat.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
		...
		background.setIcon(new ImageIcon("Images/patient.jpg"));
