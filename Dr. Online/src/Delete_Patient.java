...
public class Delete_Patient extends JFrame {
	...
	public Delete_Patient() {
		...
		JLabel lblNewLabel_1 = new JLabel("Delete Patient Record");
		...
		btn_Del.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				DBase db = new DBase();
				int save = db.delete(txt_User.getText());
		...
		btn_Del.setBounds(116, 209, 89, 23);
		...
		btn_Exit.setBounds(235, 209, 89, 23);
		...
		lblNewLabel_3.setBounds(10, 44, 416, 30);
